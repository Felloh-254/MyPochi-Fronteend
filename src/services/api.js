...
// Mirrors the routes registered backend.
export const api = {
  ...
  updateBudget: (id, payload) => request(`/api/budgets/${id}`, { 
    method: 'PUT', 
    body: payload 
  }),
  ...
  createAccount: (payload) => request('/api/accounts', { 
    method: 'POST', 
    body: payload 
  }),
  updateAccount: (id, payload) => request(`/api/accounts/${id}`, { 
    method: 'PUT', 
    body: payload 
  }),
  ...
  createRecurring: (payload) => request('/api/recurring', { 
    method: 'POST', 
    body: payload 
  }),
  updateRecurring: (id, payload) => request(`/api/recurring/${id}`, { 
    method: 'PUT', 
    body: payload 
  }),
  ...
  createGoal: (payload) => request('/api/goals', { 
    method: 'POST', 
    body: payload 
  }),
  updateGoal: (id, payload) => request(`/api/goals/${id}`, { 
    method: 'PUT', 
    body: payload 
  }),
  deleteGoal: (id) => request(`/api/goals/${id}`, { 
    method: 'DELETE' 
  }),
  contributeToGoal: (id, payload) => request(`/api/goals/${id}/contribute`, { 
    method: 'POST', 
    body: payload 
  }),
